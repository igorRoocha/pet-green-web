...
import { CatererService } from 'src/app/services/registers/caterer.service';
import { Caterer } from 'src/app/models/caterer';

@Component({
  selector: 'caterer-list',
  templateUrl: './caterer-list.component.html',
  styleUrls: ['./caterer-list.component.scss']
})
